...
file = "/var/www/html/cayetano.anccas.org/util/data-train.txt"
...
train_X, train_Y = data_encode("/var/www/html/cayetano.anccas.org/util/data-train.txt")
test_X, test_Y = data_encode("/var/www/html/cayetano.anccas.org/util/data-test.txt")
